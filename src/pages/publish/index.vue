<template>
  <div class="container">
    ...
    <div class="center">
      <i-input :value="money" type="number" right title="悬赏金 $" mode="wrapped" placeholder="最少 0.01 元" />
    </div>
    <div class="bottomPicker">
      <picker @change="tagPicker"
              :value="index"
              :range="tags">
